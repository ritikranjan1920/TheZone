...
class Student(db.Model, UserMixin):
    user_id = db.Column(db.String(14), primary_key=True, unique=True, nullable=False)
    name = db.Column(db.String(20), nullable=False)
    email = db.Column(db.String(120), unique=True, nullable=False)
    year = db.Column(db.String(1), nullable=False)
    branch = db.Column(db.String(30), nullable=False, default="CSE")
    headline = db.Column(db.String(100), nullable=False, default='Student')
    about = db.Column(db.String(300))
    clg_name = db.Column(db.String(10), nullable=False, default="ABESIT")
...
class Faculty(db.Model, UserMixin):
    ...
    email = db.Column(db.String(120), unique=True, nullable=False)
    branch = db.Column(db.String(30), nullable=False, default="CSE")
    clg_name = db.Column(db.String(30), nullable=False, default="ABESIT")
